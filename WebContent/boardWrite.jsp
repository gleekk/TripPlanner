...
<body>
	...
	<div class="container" id="body">
		<form method="post" action="./boardWriteaction.board" enctype="multipart/form-data">
			<table class="table table-bordered table-hover" style="text-align:center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="6"><h4>여행지 추천 양식</h4></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<td >
					<select style="display: inline;" name="city" id="city" class="form-control">
						<c:forEach var="city" items="${requestScope.cityList}" varStatus="status">
					...
					<td><input class="form-control" type="text" maxlength="40" name="tourist"></td>
					...
					<tr>
						...
						<td colspan="5"><input class="form-control" type="text" maxlength="50" name="boardTitle" placeholder="글제목을 입력하세요"></td>
					</tr>
					<tr>
						<td style="width:130px; vertical-align: middle;"><h5>글 내용</h5></td>
						<td colspan="5"  style="text-align:left;"><textarea class="summernote" rows="10" name="boardContent" maxlength="2048"  placeholder="글내용을 입력하세요"></textarea> </td>
					</tr>			
					<tr>
					...
					<tr>
						<td style="text-align: left;" colspan="6"><h5 style="color: red; "></h5><input class="btn btn-success pull-right" type="submit" value="등록"></td>
					</tr>
				</tbody>
			</table>
		</form>
