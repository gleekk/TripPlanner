...
<link rel="stylesheet" href="./css/custom.css">
    ...
    * { padding:0; margin:0; }
    ...
    body {
        ...
        font-size:12px;
        color:#333;
        background: #F5D1E3 url(./error/sky-404.png) repeat-x 0 0;
        color: #FFF;
        overflow-x:hidden;
        position: relative;
    }
    ...
    #cloud1 {
        ...
        height: 88px;
        left: 50px;
        background: transparent url(./error/cloud1-404.png) no-repeat scroll 0 0;
    }
    #cloud2 {
        position: absolute;
        top: 220px;
        ...
        height: 29px;
        left: 275px;
        background: transparent url(./error/cloud2-404.png) no-repeat scroll 0 0;
    }
    #gull {
        position: absolute;
        top: 150px;
...
<body>
    <div id="text">
        <h1>Oh my god.... Something's wrong here...</h1>
        <%=exception.getClass().getName() %>
    </div>
    <div id="ripple-control"></div>
    <img id="fish" src="./error/fish-404.png" />
    <div id="ripple"></div>

    <div id="cloud1"></div>
    <div id="cloud2"></div>
    <img id="gull" src="./error/gull-404.png"/>

    <ul class="bottomLinkList">
        <li><a href="#">Home</a></li>
        <li class="copy">&copy; Trip_planner </li>
    </ul>
...
c,C,B=!1,P=Math.PI/180,f,z,h,k,s=[Math.floor(0.75*d),0],n=[236,195],w,l,L,J,M,K=[75,150],E=[{h:58,w:140,t:0,l:0,mt:10},{h:72,w:150,t:-64,l:0,mt:0},{h:61,w:150,t:-151,l:0,mt:30}],N=!1;g=document.createElement("canvas");g.getContext&&(N=!0,document.body.removeChild(document.getElementById("ripple")),g.setAttribute("id","ripple"),document.body.appendChild(g),k=document.getElementById("fish"),l=document.getElementById("gull"),l.setAttribute("src","./error/gulls-404.png"));N&&(function(){try{if(fish.complete)m();
...
<!-- bitly.com error page 사용함 저작권은 이쪽에--> 
