...
$(document).ready(function() {
	...
	// 세부 계획 불러 오기 함수
		 $("#myplan").on("click", function(){
 		 ...
 		 var planNo=  $("#myplan option:selected").attr('value');
		  ...
		  $.ajax({
				...
				success : function(data) {
					if (data == "") {
						...
						$('#insertSchedule').html("<th colspan='6' style='text-align:center;'><h4>저장된 일정이 없습니다.</h4></th>");
						}else{
						$('#insertSchedule').empty();
...
<body>
	...
	<div class="container" id="body">
		<form method="post" action="./boardWriteaction.myboard" enctype="multipart/form-data">
			...
			<table class="table table-bordered table-hover" style=" text-align:center;  border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3"><input class="form-control" type="text" maxlength="50" name="myboardTitle" placeholder="글제목을 입력하세요"></td>
					...
					<tr>
						...
						<td colspan="5" style="text-align:left;"><textarea class="summernote" rows="10" name="myboardContent" maxlength="2048"  placeholder="글내용을 입력하세요"></textarea> </td>
					</tr>			
					<tr>
						...
						<td colspan="5">
							...
							<div class="input-group col-xs-12">
								...
								<input type="text" class="form-control input-lg" disabled placeholder="사진 파일을 업로드하세요.">
